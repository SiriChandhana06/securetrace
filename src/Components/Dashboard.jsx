        ...
        <div className="p-4 lg:p-10 grid grid-cols-1 lg:grid-cols-3 gap-10 md:gap-64">
            ...
            <div className="lg:col-span-1 space-y-6">
                <div className="bg-white p-6 sm:w-[300px] md:w-[550px] rounded-xl border border-black shadow-md shadow-gray-500">
                    ...
                    <table className="w-full text-center">
                        ...
                        <tbody>
                            <tr className="border-t even:bg-[#F4F4F4] odd:bg-white">
                                <td>Berry</td>
            ...
            <div className="lg:col-span-2 space-y-6">
                <div className="bg-white p-6 rounded-xl border border-black shadow-md shadow-gray-500">
                    <div className='flex'>
                    <h3 className="text-2xl font-semibold mb-4">Transfers</h3>
